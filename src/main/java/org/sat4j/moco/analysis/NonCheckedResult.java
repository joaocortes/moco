...
public class NonCheckedResult extends Result {
    /**
     ...
     */
    protected Population solutions = null;

     public NonCheckedResult(Instance m){
        this.problem = new MOCOProblem(m);
        this.solutions = new Population();
	...
	assert !isWeaklyDominated(sol, this.solutions);

...
((nil
 ...
 (java-mode
  (dap-debug-template-configurations .  (("Run unsatSat on example2" :type "java" :request "launch" :args "examples/example2.opb -alg 1 -v 6" :cwd nil :stopOnEntry :json-false :host "localhost" :request "launch"

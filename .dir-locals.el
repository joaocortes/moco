...
((nil
 ...
 (java-mode
  (dap-debug-template-configurations .  (("Run unsatSat on bugIAmFresh2" :type "java" :request "launch" :args "bugs/bugIAmFresh2/minimal.opb -alg 1 -v 6" :cwd nil :stopOnEntry :json-false :host "localhost" :request "launch"

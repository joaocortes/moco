...
("Run unsatSat on exampleXX" :type "java" :request "launch" :args "examples/exampleXX.opb -alg 1 -v 6 -enc \"SD\"" :cwd nil :stopOnEntry :json-false :host "localhost" :request "launch"

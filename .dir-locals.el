...
((nil
 ...
 (java-mode
  (dap-debug-template-configurations .  (("Run unsatSat on bugIAmFresh_2" :type "java" :request "launch" :args "./bugs/bugIAmFresh/minimal.opb -alg 1 -v 6" :cwd nil :stopOnEntry :json-false :host "localhost" :request "launch"
